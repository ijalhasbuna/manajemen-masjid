...
$infaq = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(nominal) as total FROM keuangan_pemasukan WHERE kategori='infaq'"))['total'] ?? 0;
...
// Hitung saldo total
$totalSaldo = $zakat + $infaq + $sedekah - $pengeluaran;
...
body {
    ...
    .background-blur {
      ...
      width: 100%;
      height: 100%;
      background: url('assets/img/background-masjid.jpg') center center / cover no-repeat;
    ...
    .navbar-custom {
      background-color: rgba(146, 167, 40, 0.85); 
      backdrop-filter: blur(2px);
    }
    .marquee {
      background: rgba(106, 135, 25, 0.85);
      backdrop-filter: blur(2px);
      color: white;
      padding: 12px 0;
      font-size: 1rem;
  ...
  <!-- Navbar -->
    ...
    <div class="container d-flex justify-content-between align-items-center">
      <a class="navbar-brand d-flex align-items-center fw-bold" href="#">
        <img src="assets/img/logo-masjid.jpg" alt="Logo Masjid" style="width: 80px;" class="me-2">
        <span class="text-white fs-5">Masjid</span>
      </a>
      <div>
        <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#aboutModal">Tentang Masjid</button>
...
<h3 class="text-center mb-4 fw-bold">Jadwal Shalat Hari Ini</h3>
...
<h3 class="text-center mb-3 fw-bold">Info Donasi</h3>
<div class="row justify-content-center text-center">
    <div class="col-4 col-md-2"><div class="donasi-card"><h6>Zakat</h6><h5>Rp <?= number_format($zakat,0,',','.'); ?></h5></div></div>
    <div class="col-4 col-md-2"><div class="donasi-card"><h6>Infaq</h6><h5>Rp <?= number_format($infaq,0,',','.'); ?></h5></div></div>
