...
$infaq = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(nominal) as total FROM keuangan_pemasukan WHERE kategori='infaq' AND status='verified'"));
...
$totalSaldo = ($zakat['total'] ?? 0) + ($infaq['total'] ?? 0) + ($sedekah['total'] ?? 0) - ($pengeluaran['total'] ?? 0);
...
<div class="container-fluid">
    ...
    <!-- Ringkasan -->
    <div class="row mb-4">
        <div class="col-md-3"><div class="card shadow-sm text-center"><div class="card-body"><h6>Zakat</h6><h4 class="text-success">Rp <?= number_format($zakat['total'] ?? 0, 0, ',', '.'); ?></h4></div></div></div>
        <div class="col-md-3"><div class="card shadow-sm text-center"><div class="card-body"><h6>Infaq</h6><h4 class="text-success">Rp <?= number_format($infaq['total'] ?? 0, 0, ',', '.'); ?></h4></div></div></div>
        <div class="col-md-3"><div class="card shadow-sm text-center"><div class="card-body"><h6>Sedekah</h6><h4 class="text-success">Rp <?= number_format($sedekah['total'] ?? 0, 0, ',', '.'); ?></h4></div></div></div>
        <div class="col-md-3"><div class="card shadow-sm text-center"><div class="card-body"><h6>Pengeluaran</h6><h4 class="text-danger">Rp <?= number_format($pengeluaran['total'] ?? 0, 0, ',', '.'); ?></h4></div></div></div>
    </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="kategori" class="form-select">
                                                    ...
                                                    <option value="infaq" <?= $p['kategori']=='infaq'?'selected':''; ?>>Infaq</option>
