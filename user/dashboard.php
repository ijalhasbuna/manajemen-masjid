...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card shadow-sm text-center">
                <div class="card-body">
                    <h6>Total Zakat</h6>
                    <h4 class="text-success">Rp <?= number_format($zakat['total'] ?? 0, 0, ',', '.'); ?></h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm text-center">
                <div class="card-body">
                    <h6>Total Infaq</h6>
                    <h4 class="text-success">Rp <?= number_format($infaq['total'] ?? 0, 0, ',', '.'); ?></h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm text-center">
                <div class="card-body">
                    <h6>Total Sedekah</h6>
                    <h4 class="text-success">Rp <?= number_format($sedekah['total'] ?? 0, 0, ',', '.'); ?></h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm text-center bg-light">
                <div class="card-body">
                    <h6>Pengeluaran</h6>
                    <h4 class="text-danger">Rp <?= number_format($pengeluaran['total'] ?? 0, 0, ',', '.'); ?></h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">Riwayat Donasi Anda (Terbaru)</div>
        <div class="card-body table-responsive">
            ...
            <a href="pemasukan.php" class="btn btn-primary btn-sm">Lihat Semua Donasi</a>
        </div>
    </div>
</div>
