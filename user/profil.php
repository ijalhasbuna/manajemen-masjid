    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-primary text-white">Update Profil</div>
                <div class="card-body">
                    <form method="POST">
                        <div class="mb-3">
                            <label>Nama</label>
                        ...
                        <button class="btn btn-primary" name="update_profil">Simpan Perubahan</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary">Ganti Password</div>
                <div class="card-body">
                    <form method="POST">
                        <div class="mb-3">
                        ...
                        <button class="btn btn-primary" name="ganti_password">Update Password</button>
                    </form>
                </div>
            </div>
        </div>
